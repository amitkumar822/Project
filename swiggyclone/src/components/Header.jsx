    ...
    <>
      ...
      >
        <div
          ...
          className="md:w-[600px] h-full bg-white absolute duration-[400ms] z-[9999999999] flex pt-20 justify-center dark:bg-[#212121]"
          style={{
            left: toggle ? "0%" : "-100%",
        ...
        >
          ...
          <div className="pt-16 w-[300px]">
            <div className=" relative">
              ...
              <input
                className="md:w-[400px] w-[286px] border px-8 py-4 font-semibold shadow dark:bg-[#212121]"
                type="text"
                placeholder="Search for area, string name.."
              />
            </div>
            <div className="md:w-[400px] w-[286px] border width-[250px] mt-11 py-4 px-5 flex items-center gap-5 ">
              <MdGpsFixed className="text-[25px] cursor-pointer" />
              <div>
                <h1 className="font-semibold text-[17px] hover:text-[#fc8019] dark:hover:text-[#fc8019] cursor-pointer">
            ...
            <div className="border md:w-[400px] w-[286px] mt-11 py-4 px-5 items-center grid grid-cols-1">
              <h2 className="text-[#9597A1] ml-10">RECENT SEARCHES</h2>
              <div className="w-full">
                <div className="flex items-center gap-3 mt-5">
                  <BiGitMerge className="text-[20px] cursor-pointer" />
                  <div>
                    <h1 className="font-semibold text-[17px] hover:text-[#fc8019] dark:hover:text-[#fc8019] cursor-pointer mb-1">
                      Bangalore Palace
                    </h1>
                    <h3 className="text-[14px] font-semibold cursor-pointer text-[#9597A1]">
      ...
      <header className="p-[15px] shadow-xl text-[#686b78] sticky top-0 z-[9999999] bg-white dark:bg-slate-800 dark:text-white dark:shadow-sm dark:shadow-[#b1d2eb]">
        <div className="max-w-[1300px] mx-auto flex items-center">
          ...
          <div className="md:flex hidden gap-1 items-center ml-1 text-[18px] cursor-pointer font-semibold text-[#3D4152] hover:text-[#fc8019] dark:hover:text-[#fc8019] dark:text-white hover:underline duration-100">
            <FiShoppingBag/>
           Swiggy Corporate
          </div>

          <nav className=" hidden md:flex list-none gap-8 ml-auto text-[18px] font-semibold text-[#3D4152] dark:bg-slate-800 dark:text-white">
            {/* Btn */}
            {links.map((link, index) => (
              <li
              className="flex items-center gap-2 hover:text-[#fc8019] dark:hover:text-[#fc8019] cursor-pointer dark:bg-slate-800 dark:text-white hover:underline duration-100"
              key={index}
              >
                {link.icon}
                {link.name}
