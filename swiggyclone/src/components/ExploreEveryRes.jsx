      ...
      <div className="grid md:grid-cols-2">
        {
          places.map((data,index) => {
            return(
              <div className="md:w-[619px] ml-4 mr-4 border font-semibold text-center py-4 rounded-lg shadow mb-6 cursor-pointer hover:scale-105 duration-200 dark:border-[yellow]">
              {data.place}
            </div>
            )
          })
