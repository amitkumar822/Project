...
function OnlineDelivery() {
  ...
  return (
    <div
      className="max-w-[1126px] md:mx-auto md:mt-10 mx-5 mt-7 dark:text-white"
      ref={componentRef}
    >
      ...
      <div
        className={
          isAtTop
            ? "fixed top-0 z-[9999999] bg-white dark:bg-slate-800  w-full left-0 duration-200"
            : ""
        }
      >
        <div
        ...
        >
          ...
          <div className={isAtTop ? "hidden md:flex" : "hidden"}>
            <input
              className=" w-[320px] h-12 md:rounded-lg pl-3 shadow-md border absolute bg-slate-100 outline-none dark:bg-slate-700 "
              type="text"
              placeholder="Search for restaurant and food "
            />
            <IoMdSearch className=" relative inline text-[25px] text-[#6C6E75] left-[280px] top-3 cursor-pointer dark:text-white" />
          </div>
        </div>
      </div>
