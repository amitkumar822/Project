  ...
  return (
    <>
      ...
      <div className="w-full">
        <div className="max-w-full mx-auto bg-[#F0F0F5] dark:bg-slate-900">
          ...
          {/* Footer h-[447px]*/} 
          <div className="md:h-[447px] h-screen bg-black text-white dark:bg-slate-800">
            <div className="max-w-[1100px] mx-auto grid md:grid-cols-4 grid-cols-2 gap-6 pt-10">
              ...
              <div className="max-w-[270px] mx-auto p-3">
                ...
                <ul className="text-[#9A9B9E] leading-8 font-semibold">
                  ...
                  <li className="pl-1 w-[105px] mt-1 text-[#9A9B9E] border-[0.1px] border-[#9A9B9E] rounded-md cursor-pointer">
                    589 cities{" "}
                    <IoIosArrowDown
                      onClick={moreCity}
                      className="inline hover:text-[#FDA45B] text-[18px] hover:text-[20px]"
                    />
                  </li>
                </ul>
              </div>
            ...
            <hr 
             className={`${toggle ? 'border-white dark:border-[#ccccaa]' : 'border-slate-800'}`}
            />
            ...
            >
              {/* <hr className=" border-[yellow] border-[5px] mt-10"/> */}
              <div
                className=" w-full bg-black dark:bg-slate-800 absolute duration-[400ms]"
              >
                <div 
                className="md:max-w-[1198px] mx-auto"
                >
                  <h1 className={`text-[22px] ml-2 font-bold cursor-pointer `}
                  style={{
                    padding: 20,
                    paddingLeft: 0
                  }}
                  >
                  {toggle ? ` Other cities that we deliver:` : ``}
                  </h1>
                  
                  {/* <h1 className="text-[20px] font-bold pb-4 cursor-pointer">
                  Other cities that we deliver:
                  </h1> */}
                  <ul className="text-[#9A9B9E] leading-8 font-semibold  grid md:grid-cols-4 grid-cols-2 ml-4">
                    {cities.map((citie) => (
                      <li
                      key={citie.id}
                        className={`cursor-pointer ${toggle ? `` : `h-[0px] `}`}
                      >
                        {
                          toggle ? `${citie.citie}` : ``
                        }
